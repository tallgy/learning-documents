...
Css水平垂直居中 
 ...
 我想实现一个div高宽度度由100变为110纯css实现（伪类+transition） 
 ...
 浏览器存储cooike  session webstorage 

 let、const、var 

 数组遍历方法实现reduce 

 cooike怎么保存到本地的，Cooike怎么跨域 

Promise有哪些方法  all race方法以及应用场景 
